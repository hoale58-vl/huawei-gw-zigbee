...
#define NODE_INFO_TYPE_AI_CURTAIN_MOTOR_STRING		"CurtainMo_"//窗帘电机
#define NODE_INFO_TYPE_AI_DOOR_LOCK_STRING			"Dlock_"	//智能门锁

#define NODE_INFO_TYPE_AI_WALLSOCKET_MEASURE_STRING		"WPlug_"	//墙面插座	
#define NODE_INFO_TYPE_SCENE_SWITCH_STRING				"Scene_"	//情景开关
#define NODE_INFO_TYPE_WIRED_SWITCH_STRING				"Wired_"	//无线开关
#define NODE_INFO_TYPE_DOORBELL_STRING					"Doorbell_"	//门铃
#define NODE_INFO_TYPE_DIMMING_SWITCH_STRING			"Dimming_"	//调光开关
#define NODE_INFO_TYPE_TEMPDIMMING_SWITCH_STRING		"TempDimming_"	//调光开关
...
#define NODE_INFO_TYPE_AI_CURTAIN_MOTOR			69	//智能窗帘电机
#define NODE_INFO_TYPE_AI_DOOR_LOCK				70	//智能门锁

#define NODE_INFO_TYPE_AI_WALLSOCKET_MEASURE	71//计量墙面插座

#define NODE_INFO_TYPE_LIGHT_WY					11//WY 色温灯
#define NODE_INFO_TYPE_LIGHT_RGBW				12//RGBW

#define NODE_INFO_TYPE_SCENE_SWITCH				9	//情景开关，非固定
#define NODE_INFO_TYPE_FSCENE_SWITCH			15	//情景开关，固定
#define NODE_INFO_TYPE_WIRED_SWITCH				13	//无线开关
#define NODE_INFO_TYPE_DOORBELL					14	//门铃
#define NODE_INFO_TYPE_DIMMING_SWITCH  			16	//调光开关
#define NODE_INFO_TYPE_TEMPDIMMING_SWITCH  		30	//色温开关
#define NODE_INFO_TYPE_CURTAINSWITCH_SWITCH  	31	//窗帘控制开关 
